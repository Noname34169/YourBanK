        ...
        <div className="container">
          <div className="login__wrapper">
            ...
            <form action="" onSubmit={handleSignup} data-aos="fade-up" data-aos-delay="400">
              ...
              <button className='login__button login__a' type='submit' data-aos="fade-up" data-aos-delay="800">Login</button>
              <Link className='login__bttn login__link' to={'/signup'} data-aos="fade-up" data-aos-delay="900">Sign up</Link>
            </form>
          </div>
        </div>
      </section>
